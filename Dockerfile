...
# 作者
MAINTAINER admin admin@baidu.com
# 最后更新时间
...
WORKDIR /data
RUN mkdir logs
#ADD target/alpaca-api.jar platform-admin.jar
ADD alpaca-api.jar platform-admin.jar
# 修改时区
...
# 运行jar包
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","/data/platform-admin.jar", "--mpw.key=90c06b6e7603a09d"]